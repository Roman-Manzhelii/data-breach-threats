...
const dataBreachVideo =
  'https://www.youtube.com/embed/RTT5394C7kQ?si=WLh2gU6oe7_eELWJ';
    ...
    <section className={styles.intro}>
      ...
      <div ref={wrapRef} className={styles.stageWrap}>
        <div className={styles.stagePin}>
          ...
          <div
            className={`${styles.warn} ${styles.tl} ${
              step1 ? styles.show : ""
            }`}
          >
            <WarningCard
              title={intro.cards[0].title}
              text={intro.cards[0].text}
            />
          </div>
          <div
            className={`${styles.warn} ${styles.tr} ${
              step2 ? styles.show : ""
            }`}
          >
            <WarningCard
              title={intro.cards[1].title}
              text={intro.cards[1].text}
            />
          </div>
          <div
            className={`${styles.warn} ${styles.bl} ${
              step3 ? styles.show : ""
            }`}
          >
            <WarningCard
              title={intro.cards[2].title}
              text={intro.cards[2].text}
            />
          </div>
          <div
            className={`${styles.warn} ${styles.br} ${
              step4 ? styles.show : ""
            }`}
          >
            <WarningCard
              title={intro.cards[3].title}
              text={intro.cards[3].text}
            />
          </div>
        </div>
      </div>
      ...
      <div className={`${styles.videoSection} container`}>
        <iframe
          ...
          src={dataBreachVideo}
          title="Data breach explainer video"
          loading="lazy"
