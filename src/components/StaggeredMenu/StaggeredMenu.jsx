...
export const StaggeredMenu = ({
  ...
  const disableScroll = useCallback(() => {
    ...
    savedOverflowRef.current = b.style.overflow || "";
  ...
  const enableScroll = useCallback(() => {
    const b = document.body;
    b.style.overflow = savedOverflowRef.current;
    if (touchBlockerRef.current) {
      window.removeEventListener("touchmove", touchBlockerRef.current);
  ...
  const onItemClick = useCallback(
    (e) => {
      ...
      if (href.startsWith("#")) {
        ...
        if (openRef.current || open || closing) toggleMenu();
        else navigateTo(href);
      }
    },
    [toggleMenu, navigateTo, open, closing]
  );
